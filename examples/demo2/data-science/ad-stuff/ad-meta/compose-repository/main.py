...
# App folder
app_dir = '/gpfs/bsc_home/xpliu/scanflow/examples/demo2/data-science/'

# Workflows
workflow1 = [
    {'name': 'gathering-20210119160118', 'file': 'gathering.py',
            'env': 'gathering'},

    {'name': 'preprocessing-20210119160118', 'file': 'preprocessing.py',
            'env': 'preprocessing'},

]
workflow2 = [
    {'name': 'modeling-20210119160118', 'file': 'modeling.py',
            'env': 'modeling'},
