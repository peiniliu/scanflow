...
sudo /usr/local/bin/kubectl delete -f tracker-workflow1-service.yaml
sudo /usr/local/bin/kubectl delete -f tracker-workflow2-service.yaml
sudo /usr/local/bin/kubectl delete -f predictor-service.yaml
