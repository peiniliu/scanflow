...
# App folder
app_dir = '/gpfs/bsc_home/xpliu/scanflow/kubernetes/demo3/data-eng/'

# Workflows
workflow1 = [
    {'name': 'gathering-20210108095411', 'file': 'gathering.py',
            'env': 'gathering'},

    {'name': 'preprocessing-20210108095411', 'file': 'preprocessing.py',
            'env': 'preprocessing'},

]
workflow2 = [
    {'name': 'modeling-20210108095411', 'file': 'modeling.py',
            'env': 'modeling'},
